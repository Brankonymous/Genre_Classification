...
# Ocitavanje fajla
with open('LPCC Method/lpcc_features_nata.csv') as csv_file:
...
model.fit(X_train, Y_train, epochs = 57, callbacks = [es],  validation_data = (X_val, Y_val), shuffle = True)
